...
filepath = os.path.join(os.path.dirname(__file__), 'data/processed_15_1-SD-3X_LQC.csv')
...
if args.api == 'train':
  ...
  payload['params']['size'] = 6
  payload['params']['first_num_iteration'] = 1500
