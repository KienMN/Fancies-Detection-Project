...
filepath = os.path.join(os.path.abspath(os.path.dirname(__file__)), 'data/processed_SVNE-2P_SVNE-2P-new.csv')
...
# Training the SOM
from detection.competitive_learning_network import MiniSom
