...
filepath = os.path.join(os.path.dirname(__file__), 'data/processed_SVNE-2P_SVNE-2P-new.csv')
...
lvq = LvqNetworkWithNeighborhood(n_feature = 6, n_rows = 10, n_cols = 10, n_class = 3,
