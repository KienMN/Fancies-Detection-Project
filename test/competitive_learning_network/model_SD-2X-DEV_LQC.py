...
if args.api == 'train':
  ...
  payload['params']['size'] = 15
  payload['params']['first_num_iteration'] = 4000
  payload['params']['second_num_iteration'] = 1500
  payload['params']['first_epoch_size'] = 300
  payload['params']['second_epoch_size'] = 300
  payload['params']['learning_rate'] = 0.7
  payload['params']['decay_rate'] = 1
  payload['params']['neighborhood'] = 'bubble'
  payload['params']['sigma'] = 2
  payload['params']['sigma_decay_rate'] = 1
  payload['params']['weights_init'] = "pca"
  ...
  payload = {}
  payload['model_id'] = "model-SD-1X-LQC"
  payload['dataset'] = {}
  payload['dataset']['features'] = X_test.tolist()
