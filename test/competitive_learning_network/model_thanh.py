...
filepath = os.path.join(os.path.dirname(__file__), 'data/input_som.csv')
...
if args.api == 'train':
  ...
  payload['params']['size'] = 10
  payload['params']['first_num_iteration'] = 4000
  payload['params']['second_num_iteration'] = 4000
  payload['params']['first_epoch_size'] = 500
  payload['params']['second_epoch_size'] = 500
