...
bsub "python3 model-features.py -tr 1X,2X,3X -te 4X -m 123-1345-maxvoting5p-1 -s 30 -fi 30000 -si 30000 -lr 0.75 -sig 3 -n gaussian -c 1,3,4,5 > result/123_1345_maxvoting5p-1.txt 2>&1"
bsub "python3 model-features.py -tr 1X,2X,3X -te 4X -m 123-1345-maxvoting5p-2 -s 30 -fi 10000 -si 30000 -lr 0.75 -sig 3 -n gaussian -c 1,3,4,5 > result/123_1345_maxvoting5p-2.txt 2>&1"
bsub "python3 model-features.py -tr 1X,2X,3X -te 4X -m 123-1345-maxvoting5p-3 -s 30 -fi 30000 -si 10000 -lr 0.75 -sig 3 -n gaussian -c 1,3,4,5 > result/123_1345_maxvoting5p-3.txt 2>&1"

bsub "python3 model-features.py -tr 2X,3X,4X -te 1X -m 234-1345-maxvoting5p-1 -s 30 -fi 30000 -si 30000 -lr 0.75 -sig 3 -n gaussian -c 1,3,4,5 > result/234_1345_maxvoting5p-1.txt 2>&1"
bsub "python3 model-features.py -tr 2X,3X,4X -te 1X -m 234-1345-maxvoting5p-2 -s 30 -fi 10000 -si 30000 -lr 0.75 -sig 3 -n gaussian -c 1,3,4,5 > result/234_1345_maxvoting5p-2.txt 2>&1"
bsub "python3 model-features.py -tr 2X,3X,4X -te 1X -m 234-1345-maxvoting5p-3 -s 30 -fi 30000 -si 10000 -lr 0.75 -sig 3 -n gaussian -c 1,3,4,5 > result/234_1345_maxvoting5p-3.txt 2>&1"