...
model_filepath = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models/model-SSOM-1X.sav')
label_filepath = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models/label-SSOM-1X.sav')
scaler_filepath = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models/scaler-SSOM-1X.sav')
