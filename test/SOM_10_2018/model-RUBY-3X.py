...
model_filepath = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models/model-SSOM-RUBY-3X.sav')
label_filepath = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models/label-SSOM-RUBY-3X.sav')
scaler_filepath = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'models/scaler-SSOM-RUBY-3X.sav')
