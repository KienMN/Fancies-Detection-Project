...
# filepath = os.path.dirname(os.path.dirname(os.getcwd())) + '/new_data/SVNE-2P_SVNE-2P-new.csv'
filepath = os.path.dirname(os.path.dirname(os.getcwd())) + '/new_data/15_1-SD-1X_LQC.csv'
